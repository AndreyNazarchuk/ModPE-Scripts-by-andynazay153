...
this mod makes fists hurt like a stone sword :D idea from: https://www.minecraftpvp.com/kits
...
if (cmd[0] == "boxer" && cmd[1] == "off"){
	if(boxer = true){
		boxer = false;
		clientMessage("Boxer Fists is now off.");
}
}
	else if(boxer = false){
...
if (cmd[0] == "boxer" && cmd[1] == ""){
  clientMessage("");
  clientMessage("");
}
	else if (cmd[0] == "boxer" && cmd[1] == ""){
		clientMessage("");
}
if (cmd[0] == "boxer" && cmd[1] == ""){
  clientMessage("");
