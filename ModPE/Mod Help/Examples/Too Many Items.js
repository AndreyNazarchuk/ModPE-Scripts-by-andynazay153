...
var CAT_SPAWN = 8;
var CAT_SPAWN_ITEMS = [];
var CAT_EXTENDEDCRAFT = 10; 
var CAT_EXTENDEDCRAFT_ITEMS = [];
...
function openMenu(){
	...
	try{
		...
		addMenuCategory(ctx, layout, sExtendedCraft, CAT_EXTENDEDCRAFT_ITEMS);
...
var sExtendedCraft = "ExtendedCraft";
var sCustom = "Custom";
...
// Glowing Redstone Ore (74)
	...
	CAT_EXTENDEDCRAFT_ITEMS = [
	  {name: "ExtendedCraft Guide", id: 322, data: 0},
	  {name: "Rubber Wood", id: 23, data: 0},
	  {name: "Rubber Leaves", id: 25, data: 0},
	  {name: "Rubber Sapling", id: 55, data: 0},
	  {name: "Rubber", id: 327, data: 0},
	  {name: "Plastic", id: 335, data: 0},
	  {name: "Copper Ore", id: 28, data: 0},
	  {name: "Copper Ingot", id: 326, data: 0},
	  {name: "Machine Block", id: 29, data: 0},
	  {name: "Wire", id: 33, data: 0},
	  {name: "Solar Panel", id: 34, data: 0},
	  {name: "Battery", id: 343, data: 0},
	  {name: "Battery Box", id: 36, data: 0},
	  {name: "Grinder", id: 69, data: 0},
	  {name: "Extractor", id: 75, data: 0},
	  {name: "Geothermal Generator", id: 70, data: 0},
	  {name: "Electric Furnace", id: 72, data: 0},
	  {name: "Extraction Item Pipe", id: 181, data: 0},
	  {name: "Item Pipe", id: 182, data: 0},
	  {name: "Farmer", id: 184, data: 0}
	  ];
...
function setLangPolish(){
    ...
    sFailButton = "Nie uda�o si� pokaza� przycisku.";
    sFailMenu = "Nie uda�o si� pokaza� menu, poniewa�: ";
    sReload = "Za�aduj ponownie �wiat, aby zastosowa�.";
    sStopRiding = "Aby zako�czy� jazd�, dotknij na zwierz� ponownie.";
    ...
    sSpawnSet = "Tw�j punkt spawn'u zosta� ustawiony w aktualnej pozycji.";
    sRideAnimal = "Jed� na zwierz�ciu";
    sTapAnimal = "Dotknij na zwierz�cie, na kt�rym chcesz jecha�.";
    ...
    sRemoveEntities = "Usu� wszystkie istoty typu...";
    sMakeWeak = "Zr�b moby s�abe typu...";
    sMakeStrong = "Zr�b moby bardzo silne typu...";
    sSelectEntType = "Wybierz typ istot...";
    sTapBlocks = "Dotknij na bloki, aby spawnowa� wybrane istoty. Aby zako�czy� naci�nij na g��wny przycisk.";
    sAge = "Ustaw wiek";
    sBaby = "Dziecko";
    sFullGrown = "Doros�y";
    sButtonPos = "Wybierz pozycj� przycisku";
    sPosTopLeft = "G�rny-lewy r�g, pod paskiem �ycia";
    sPosTopRight = "G�rny-prawy r�g, za przyciskiem chat'u";
    sBottomLeft = "Dolny-lewy r�g";
    sBottomRight = "Dolny-prawy r�g";
    ...
    CAT_STARTER_KIT_ITEMS = [
      ...
      {name: "Diamentowy Napier�nik", id: 311, data: 0},
    ...
    CAT_BUILDING_ITEMS = [
      ...
      {name: "Blok Diament�w", id: 57, data: 0},
      {name: "Blok Z�ota", id: 41, data: 0},
      {name: "Blok �elazny", id: 42, data: 0},
      {name: "Blok W�gla", id: 173, data: 0},
      ...
      {name: "P��blok Stone", id: 44, data: 0},
      {name: "P��blok Sandstone", id: 44, data: 1},
//Wooden Slab (44:2)
      {name: "P��blok drewna", id: 158, data: 0},
      {name: "P��blok Ciemnego Drewna", id: 158, data: 1},
      {name: "P��blok Brzozy", id: 158, data: 2},
      {name: "P��blok Cobblestone", id: 44, data: 3},
      {name: "P��blok Ceg�y", id: 44, data: 4},
      {name: "P��blok Stone Ceg�y", id: 44, data: 5},
//Stone Slab (44:6)
      {name: "P��blok Quartzu", id: 44, data: 7},
...
// Invisible bedrock (95)
      ...
      {name: "Szk�o cie�kie", id: 102, data: 0}];
      
    CAT_DECORATION_ITEMS = [
      {name: "Dynia", id: 86, data: 0},
      {name: "Jack'o'Lantern", id: 91, data: 0},
      {name: "Dywan Bia�y", id: 171, data: 0},
      {name: "Z��ty Kwiat", id: 37, data: 0},
      {name: "Niebieski Kwiat", id: 38, data: 0},
      {name: "P��ka z Ksi��kami", id: 47, data: 0},
      {name: "Snieg", id: 78, data: 0},
      {name: "L�d", id: 79, data: 0},
      {name: "Blok �niegu", id: 80, data: 0},
...
// info_reserved6 (255)
    ...
    CAT_ITEMS_ITEMS = [
      {name: "Ruda Diament�w", id: 56, data: 0},
      {name: "Ruda Z�ota", id: 14, data: 0},
      {name: "Ruda �elaza", id: 15, data: 0},
      {name: "Ruda W�gla", id: 16, data: 0},
...
// Glowing Redstone Ore (74)
      ...
      {name: "Ko��", id: 352, data: 0},
      {name: "Paj�czyna", id: 287, data: 0},
      {name: "Sk�ra", id: 334, data: 0},
      {name: "Pi�ro", id: 288, data: 0},
    ...
    CAT_SPAWN_ITEMS = [
      ...
      {name: "Jajko spawnuj�ce �winie", id: 383, data: 12},
...
// Burning Furnance (62)
      ...
      {name: "���ko", id: 355, data: 0},
      {name: "W�giel", id: 263, data: 0},
      {name: "W�giel Drzewny", id: 263, data: 1},
      ...
      {name: "Ziarna Buraczk�w", id: 458,data: 0},
...
// Lava (10)
      ...
      {name: "Li�cie Drzewa", id: 18, data: 0},
      {name: "Li�cie Ciemnego Drzewa", id: 18, data: 1},
      {name: "Lisccie Brzozy", id: 18, data: 2},
      {name: "Sponage", id: 19,data: 0},
      {name: "���ko", id: 26, data: 0},
      {name: "Paj�czyna Stoj�ca", id: 30, data: 0},
